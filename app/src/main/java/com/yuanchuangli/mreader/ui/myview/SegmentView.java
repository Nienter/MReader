package com.yuanchuangli.mreader.ui.myview;
...
import static com.yuanchuangli.mreader.R.drawable.changetextcolor;

/**
 * Created by Blank on 2016/12/26 15:19
 */
...
public class SegmentView extends LinearLayout {
    ...
    public void init() {
        ...
        //添加控件文字及大小
        lateone.setText("浏览记录");
        latetwo.setText("下载记录");
        latethree.setText("文档交易");
        ...
        xrp = getResources().getXml(changetextcolor);
        try {
    ...
    public void setOnsegmentlistenerclicker(OnSegmentClickListener listener) {
        if (listener != null)
